    ...
    <div class="font-sans flex flex-col items-center">
        ...
        <main class=" w-full flex flex-col items-center">
            <div>
                ...
                <h2 class="mt-8 pb-1 font-bold text-xl text-black border-b border-indigo-200">Advantages</h2>
                
                <div class="flex flex-col sm:flex-row sm:-mx-2">
                    <div class="mt-4 sm:w-1/3">
                        <div class="bg-white p-8 h-full border-b-4 border-black rounded-lg flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            <div class="bg-gray-200 text-black w-16 p-2 rounded-full">
                    ...
                    <div class="mt-4 sm:w-1/3">
                        <div class="bg-white p-8 border-b-4 border-black rounded-lg flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            <div class="bg-gray-200 text-black w-16 p-2 rounded-full">
        ...
        <footer class="w-full bg-gray-800 pb-8 text-center text-xs font-light text-gray-600">
            <p>Copyright &copy; Zur Nedden 2021</p>
        </footer>
