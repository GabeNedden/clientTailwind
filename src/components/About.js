        ...
        <div class="font-construct flex flex-col">
            ...
            <div class="bg-white self-center w-10/12 md:w-1/2 py-8">
                ...
                <div class="flex flex-col sm:flex-row mb-8">
                    <div class="sm:w-1/3">
                        <div class="bg-white p-8 h-full flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            <div class="mt-4 font-bold">Customer Service</div>
                            <div class="mt-2 text-sm text-gray-600 text-center">We strive for exceptional customer service in every project from start to finish.  Timelines, budgets, materials and professionalism are foundational to our success.</div>
                        </div>
                    </div>

                    <div class="sm:w-1/3">
                        <div class="bg-white p-8 flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            <div class="mt-4 font-bold">Environmental Awareness</div>
                            <div class="mt-2 text-sm text-gray-600 text-center">We take an environmentally conscious approach to projects by considering the methods of construction, orientation and long term effects of the materials and products we use.  Local, environmentally responsible and sustainable products are encouraged.</div>
                        </div>
                    </div>
                    
                    <div class="sm:w-1/3">
                        <div class="bg-white p-8 h-full flex flex-col items-center sm:mx-2 sm:p-3 md:p-8">
                            <div class="mt-4 font-bold">Quality</div>
                            <div class="mt-2 text-sm text-gray-600 text-center">We take pride in our outstanding workmanship, honesty, reliability and professional integrity. Each project and client is important to us and we ensure that our work reflects our high standards.</div>
                        </div>
                    </div>
